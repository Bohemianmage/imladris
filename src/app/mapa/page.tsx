  ...
  return (
    <MemberGate domain="mapa">
      <div className="relative z-10 flex min-h-dvh flex-col items-center justify-center px-6 py-16 text-center gap-6">
        <Reveal>
          <Sparkles className="mx-auto h-10 w-10 text-gold" strokeWidth={1.25} aria-hidden />
        </Reveal>
        <Reveal delay={0.12}>
          <h1 className="font-display text-parchment text-3xl">Mapa</h1>
        </Reveal>
        <Reveal delay={0.24}>
          <p className="font-subtitle text-parchment/55 text-lg">Sin estrellas aún</p>
        </Reveal>
        <Reveal delay={0.36}>
          <Link
            href="/"
